  ...
  const cards = [
    {
      ...
      title: 'Lorem',
      text: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla quam sint quo unde! Suscipit repudiandae id deleniti! Error harum maiores velit quos minus.',
    },
    {
    ...
    {
      iconClass: 'fa-regular fa-life-ring fa-2x',
      title: 'Lorem',
      text: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla quam sint quo unde! Suscipit repudiandae id deleniti! Error harum maiores velit quos minus.',
    },
    {
      iconClass: 'fa-solid fa-route fa-2x',
      title: 'Lorem',
      text: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla quam sint quo unde! Suscipit repudiandae id deleniti! Error harum maiores velit quos minus.',
    },
  ];
            ...
            <div className="col-12">
              ...
              <div className="row pt-5 text-white">
                {cards.map((card, index) => (
                  <article key={index} className="col-12 col-md-6 col-xl-3 card-container">
                    <div className={`p-3 card-${index + 1}`}>
